...
const en = {
  ...
  hero: {
    ...
    titleItalic: 'Chasing sunsets,',
    titleMain: 'saving moments',
    sub: 'Outdoor lifestyle sessions for maternity, families, couples and weddings. No stiff poses — just you, your story and the best light of the day.',
...
const es: Dictionary = {
  ...
  hero: {
    ...
    titleItalic: 'Persigo atardeceres,',
    titleMain: 'guardo momentos',
    sub: 'Sesiones lifestyle de maternidad, familias, parejas y bodas en plena naturaleza. Sin poses rígidas: solo ustedes, su historia y la mejor luz del día.',
